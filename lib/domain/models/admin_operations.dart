...
class VerificationQueueItem {
  ...
  factory VerificationQueueItem.fromJson(Map<String, dynamic> json) {
    return VerificationQueueItem(
      ...
      complaintCreatedAt: (DateTime.tryParse(json['complaint_created_at'] as String? ?? '') ?? DateTime.now()).toLocal(),
      ...
      completedAt: (DateTime.tryParse(json['completed_at'] as String? ?? '') ?? DateTime.now()).toLocal(),
